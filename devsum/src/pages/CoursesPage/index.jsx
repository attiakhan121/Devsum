...
const Coursespage = () => {
  ...
  const filteredData = coursesData.courses.filter(
    (course) =>
  ...
  return (
    <>
      <Breadcrumb
        pageName="Courses"
        url="/"
        description="Learn in-demand tech skills through expert-led, hands-on courses."
      />

      <section className="relative z-1 my-6">
        <div className="container">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between mb-13">
            {/* <!-- top bar left --> */}
            <div className="flex items-center gap-2.5">
              <Button
                aria-label="button for Course grid tab"
                variant="ghost"
                size="lg"
              ...
              <Button
                aria-label="button for Course list tab"
                variant="ghost"
                size="lg"
          ...
          {viewType === "grid" ? (
            ...
            <div className="flex flex-col gap-6">
              {filteredData.length > 0 ? (
                filteredData.map((course) => (
                  <SingleListItem key={course.id} course={course} />
                ))
              ) : (
                <div className="h-[40vh] my-50">
                  <Empty />
